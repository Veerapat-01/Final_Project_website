...
export async function POST(request) {
  try {
    ...
    console.log("[validatedevice] found device:", matched.chasisNumber, "serial:", matched.serialNumber);
    ...
    console.log("[validatedevice] POST /certificate/save/vedge/list payload:", JSON.stringify(savePayload));
    ...
    console.log("[validatedevice] save status:", saveResponse.status);
    console.log("[validatedevice] save response:", JSON.stringify(saveResponse.data));
    ...
    console.log("[validatedevice] error:", error.message);
